...
export const GOOGLE_VISION_KEY: string | undefined = Config.GOOGLE_VISION_KEY;
export const MICROSOFT_VISION_KEY: string | undefined = Config.MICROSOFT_VISION_KEY;
